...
module.exports = {
  ...
  'app-copyright': `Copyright (c) ${new Date().getFullYear()} Zlsoftdq.Inc`,
  'win32metadata': {
    CompanyName: 'Zlsoftdq.Inc',
    FileDescription: 'ZL-Note',
    OriginalFilename: 'ZL-Note.exe',
    ProductName: pkg.productName,
    InternalName: 'ZL-Note.exe'
  }
}
